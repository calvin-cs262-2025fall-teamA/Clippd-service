...
INSERT INTO UserAccount (ID, firstName, lastName, loginID, passWord, role, nickname, address, city, state, emailAddress, phone, bio, profileImage, latitude, longitude, createdAt)
VALUES (8, 'Keith', 'VanderLinden', 'client3', 'clientpw3', 'Client', 'Max', '123 Pine St', 'Grand Rapids', 'MI', 'max@example.com', '616-111-1111', 'Loves stylish short cuts.', 'https://example.com/max.jpg', 42.963795, -85.670006, '2025-09-27 08:00:00');

INSERT INTO UserAccount (ID, firstName, lastName, loginID, passWord, role, nickname, address, city, state, emailAddress, phone, bio, profileImage, latitude, longitude, createdAt)
VALUES (2, 'Ben', 'Nelson', 'ben123', 'passBen!', 'Clipper', 'BennyFade', '45 Barber Ln', 'Grand Rapids', 'MI', 'ben@example.com', '616-222-2222', 'Professional barber with 5 years of experience.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop', NULL, NULL, '2025-09-29 15:00:00');
...
INSERT INTO UserAccount (ID, firstName, lastName, loginID, passWord, role, nickname, address, city, state, emailAddress, phone, bio, profileImage, latitude, longitude, createdAt)
VALUES (4, 'Mrs.', 'VanderLinden', 'clipper', 'clipperpw', 'Clipper', 'MrsV', '123 Clipper St', 'Grand Rapids', 'MI', 'mvanderlinden@example.com', '616-444-4444', 'Professional stylist with years of experience.', 'https://cdn-icons-png.flaticon.com/512/9159/9159760.png', NULL, NULL, '2025-11-01 10:00:00');
...
-- Ben Nelson' portfolio images
INSERT INTO Pictures (ID, portfolioID, image, addedAt) VALUES (1, 1, 'https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=1280&h=900&fit=crop', '2025-10-02 08:00:00');
...
-- Chris Evan's portfolio images
INSERT INTO Pictures (ID, portfolioID, image, addedAt) VALUES
(3, 2, 'https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=1280&h=900&fit=crop', '2025-10-05 12:00:00'),
(18, 2, 'https://images.unsplash.com/photo-1620331311520-246422fd82f9?w=1280&h=900&fit=crop', '2025-10-05 12:15:00'),
(20, 2, 'https://images.unsplash.com/photo-1605497788044-5a32c7078486?w=1280&h=900&fit=crop', '2025-10-05 12:45:00');
...
INSERT INTO Pictures (ID, portfolioID, image, addedAt) VALUES
(7, 4, 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=1280&h=900&fit=crop', '2025-11-02 14:15:00'),
(8, 4, 'https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=1280&h=900&fit=crop', '2025-11-02 14:16:00'),
(9, 4, 'https://images.unsplash.com/photo-1605497788044-5a32c7078486?w=1280&h=900&fit=crop', '2025-11-02 14:17:00');

-- Will Johnson's portfolio images
INSERT INTO Pictures (ID, portfolioID, image, addedAt) VALUES
(14, 5, 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?w=1280&h=900&fit=crop', '2025-11-03 16:17:00'),
(15, 5, 'https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=1280&h=900&fit=crop', '2025-11-03 16:18:00'),
(16, 5, 'https://images.unsplash.com/photo-1621607512214-68297480165e?w=1280&h=900&fit=crop', '2025-11-03 16:19:00');
...
INSERT INTO Review (ID, clientID, clipperID, rating, comment, createdAt) VALUES (4, 3, 3, 5, 'I love my wife, but not sure about the haircut.', '2025-11-10 10:00:00');
INSERT INTO Review (ID, clientID, clipperID, rating, comment, createdAt) VALUES (5, 2, 3, 5, 'Very professional.', '2025-11-11 14:00:00');
INSERT INTO Review (ID, clientID, clipperID, rating, comment, createdAt) VALUES (6, 1, 3, 5, 'Best barber in town!', '2025-11-12 16:00:00');
...
INSERT INTO Review (ID, clientID, clipperID, rating, comment, createdAt) VALUES (2, 2, 5, 5, 'I like his style!', '2025-10-28 16:00:00');
...
INSERT INTO Review (ID, clientID, clipperID, rating, comment, createdAt) VALUES (8, 2, 1, 5, 'Ben is my go-to barber!', '2025-11-14 12:00:00');